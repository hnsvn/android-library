...
## server
docker run --name=uiComparison hnscloudci/server 1>/dev/null &
sleep 5
...
docker exec uiComparison /bin/sh -c "su www-data -c \"git clone -b master https://github.com/hnscloud/activity.git /var/www/html/apps/activity/\""
docker exec uiComparison /bin/sh -c "su www-data -c \"php /var/www/html/occ app:enable activity\""
docker exec uiComparison /bin/sh -c "su www-data -c \"git clone -b master https://github.com/hnscloud/text.git /var/www/html/apps/text/\""
docker exec uiComparison /bin/sh -c "su www-data -c \"php /var/www/html/occ app:enable text\""
docker exec uiComparison /bin/sh -c "su www-data -c \"git clone -b master https://github.com/hnscloud/end_to_end_encryption/ /var/www/html/apps/end_to_end_encryption/\""
docker exec uiComparison /bin/sh -c "su www-data -c \"php /var/www/html/occ app:enable end_to_end_encryption\""
docker exec uiComparison /bin/sh -c "su www-data -c \"git clone -b master https://github.com/hnscloud/password_policy/ /var/www/html/apps/password_policy/\""
