...
URL=https://hnscloud.kaminsky.me/remote.php/dav/files/$USER/library-integrationTests

# upload logcat
log_filename=$ID"_logcat.txt.xz"
log_file="${log_filename}"
upload_path="https://hnscloud.kaminsky.me/remote.php/webdav/library-logcat/$log_filename"
xz logcat.txt
...
curl -u $GIT_USERNAME:$GIT_TOKEN -X POST https://api.github.com/repos/hnscloud/android-library/issues/$PR_ID/comments -d "{ \"body\" : \"$BRANCH_TYPE test failed: https://www.kaminsky.me/nc-dev/library-integrationTests/$REMOTE_FOLDER/debug/ \" }"
exit 1
