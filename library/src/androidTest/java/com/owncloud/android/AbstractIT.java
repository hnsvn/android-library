...
public abstract class AbstractIT {
    ...
    protected static HnscloudClient hnscloudClient;
    ...
    public static void beforeAll() throws InterruptedException,
        ...
        OwnCloudClientManagerFactory.setUserAgent("Mozilla/5.0 (Android) Hnscloud-android/1.0.0");

        String userId = loginName; // for test same as userId
        String credentials = Credentials.basic(loginName, password);
        hnscloudClient = new HnscloudClient(url, userId, credentials, context);
