...
class HnscloudClient private constructor(
    val delegate: HnscloudUriDelegate,
    var credentials: String,
    val client: OkHttpClient,
    val context: Context
) : HnscloudUriProvider by delegate {
    ...
    constructor(
        ...
        client: OkHttpClient,
        context: Context
    ) : this(HnscloudUriDelegate(baseUri, userId), credentials, client, context)
    ...
    companion object {
        @JvmStatic
        val TAG = HnscloudClient::class.java.simpleName
