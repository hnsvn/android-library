...
public class OwnCloudVersion implements Comparable<OwnCloudVersion>, Parcelable {
    public static final OwnCloudVersion hnscloud_16 = new OwnCloudVersion(0x10000000); // 16.0
    public static final OwnCloudVersion hnscloud_17 = new OwnCloudVersion(0x11000000); // 17.0
    public static final OwnCloudVersion hnscloud_18 = new OwnCloudVersion(0x12000000); // 18.0
    public static final OwnCloudVersion hnscloud_19 = new OwnCloudVersion(0x13000000); // 19.0
    public static final OwnCloudVersion hnscloud_20 = new OwnCloudVersion(0x14000000); // 20.0
    ...
    public boolean isShareesOnDavSupported() {
        return isNewerOrEqual(hnscloud_17);
    }
