...
import com.hnscloud.common.DNSCache;
import com.hnscloud.common.HnscloudUriDelegate;
...
public class OwnCloudClient extends HttpClient {
    ...
    private final HnscloudUriDelegate hnscloudUriDelegate;
    ...
    public OwnCloudClient(Uri baseUri, HttpConnectionManager connectionMgr, Context context) {
        ...
        hnscloudUriDelegate = new HnscloudUriDelegate(baseUri);
...
//	        logSetCookiesAtResponse(method.getResponseHeaders());
    ...
    public String getFilesDavUri(String path) {
        return hnscloudUriDelegate.getFilesDavUri(path);
    }

    public Uri getFilesDavUri() {
        return hnscloudUriDelegate.getFilesDavUri();
    }

    public Uri getUploadUri() {
        return hnscloudUriDelegate.getUploadUri();
    }

    public Uri getDavUri() {
        return hnscloudUriDelegate.getDavUri();
    }

    public String getCommentsUri(long fileId) {
        return hnscloudUriDelegate.getCommentsUri(fileId);
    }


    public Uri getBaseUri() {
        return hnscloudUriDelegate.getBaseUri();
    }

    public void setBaseUri(Uri uri) {
        hnscloudUriDelegate.setBaseUri(uri);
    }

    public void setUserId(String userId) {
        hnscloudUriDelegate.setUserId(userId);
    }
    ...
    @SuppressFBWarnings(value = "SBSC_USE_STRINGBUFFER_CONCATENATION", justification = "replaced by HnscloudClient")
    ...
    public String getUserId() {
        return hnscloudUriDelegate.getUserIdEncoded();
    }

    public String getUserIdPlain() {
        return hnscloudUriDelegate.getUserId();
    }
