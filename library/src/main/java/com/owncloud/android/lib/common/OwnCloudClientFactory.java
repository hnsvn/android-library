...
public class OwnCloudClientFactory {
     ...
     * @return A OwnCloudClient object ready to be used
     */
    public static HnscloudClient createHnscloudClient(Uri uri,
                                                        String userId,
                                                        String credentials,
                                                        Context context,
        ...
        HnscloudClient client = new HnscloudClient(uri, userId, credentials, context);
        client.setFollowRedirects(followRedirects);

        return client;
    }

    public static HnscloudClient createHnscloudClient(User user, Context appContext) throws AccountNotFoundException {
        return createHnscloudClient(user.toPlatformAccount(), appContext);
    }

    /**
     * Creates a HnscloudClient
     *
     * Do not call this method from the main thread.
     *
     * @param account                       The hnscloud account
     * @param appContext                    Android application context
     * @return                              A Hnscloud object ready to be used
     * @throws AccountNotFoundException     If 'account' is unknown for the AccountManager
     */
    public static HnscloudClient createHnscloudClient(Account account, Context appContext)
        ...
        return createHnscloudClient(baseUri,
                                     userId,
