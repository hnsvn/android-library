...
public class Log_OC {
    ...
    private static String mHnscloudDataFolderLog;
    ...
    synchronized public static void startLogging(Context context) {
        mHnscloudDataFolderLog = context.getFilesDir().getAbsolutePath() + File.separator + LOG_FOLDER_NAME;
        mFolder = new File(mHnscloudDataFolderLog);
        ...
        if (!mFolder.exists()) {
            ...
            Log.d(TAG, "Log folder created at: " + mHnscloudDataFolderLog);
        } else {
